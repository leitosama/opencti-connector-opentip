...
from opentip.models.configs.connector_configs import (
...
class ConfigLoaderConnector(ConfigLoaderConnectorExtra):
    ...
    id: str = Field(
        default="opentip--9b7842f4-078f-4cec-8550-1c586d075a77",
...
class ConfigLoader(ConfigBaseSettings):
    ...
    opentip: ConfigLoaderOpenTIP = Field(
        default_factory=ConfigLoaderOpenTIP,
        description="OpenTIP configurations.",
    )
